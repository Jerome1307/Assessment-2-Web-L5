        ...
        {   
            ...
            levels: {
                ...
                easy: [
                    ...
                    { question: "What is the name of the title track Illit debuted with?", choices: ["Lucky Girl Syndrome", "My World", "Cherish My Love", "Magnetic"], answer: "Magnetic" }
                ...
                medium: [
                    ...
                    { question: "What is Iroha's MBTI?", choices: ["ENTJ", "INFJ", "ESTP", "ISFP"], answer: "INFJ" },
                    ...
                    { question: "What is the Duo name of Yunah and Minju", choices: ["Moheetoz", "Cheetoz", "Heeroz", "Mimoz"], answer: "Cheetoz" },
                    ...
                    { question: "Who had the longest training period before R U NEXT? aired?", choices: ["Minju", "Yunah", "Moka", "Wonhee"], answer: "Yunah" },
                    { question: "Who had the shortest training period before R U NEXT? aired?", choices: ["Moka", "Iroha", "Wonhee", "Minju"], answer: "Wonhee" },
                ...
                hard: [
                    ...
                    { question: "What is the Duo name of Moka and Minju", choices: ["Mimoz", "Mokarongz", "Moheetoz", "Heeroz"], answer: "Mimoz" },
                    { question: "What is the Duo name of Iroha and Moka", choices: ["Cheetoz", "Moheetoz", "Mimoz", "Mokarongz"], answer: "Mokarongz" },
                    { question: "What is the Duo name of Wonhee and Moka", choices: ["Mokarongz", "Mimoz", "Moheetoz", "Cheetoz"], answer: "Moheetoz" },
                    { question: "What is the Duo name of Wonhee and Iroha", choices: ["Mokarongz", "Heeroz", "Cheetoz", "Mimoz"], answer: "Heeroz" },
                    { question: "What is the name of the song Illit released alongside Megapass?", choices: ["NOT CUTE ANYMORE", "Midnight Fiction", "Bamsopoong", "ALL FOR YOU"], answer: "ALL FOR YOU" },
                    { question: "What is the name of the first Japanese release of Illit?", choices: ["Toki Yo Tomare", "Almond Chocolate", "Sunday Morning", "Topping"], answer: "Toki Yo Tomare" },
                    { question: "What is the name of this song?", image: "/audios/Illit/Bamsopoong.mp3", choices: ["Bamsopoong", "My World", "Lucky Girl Syndrome", "Midnight Fiction"], answer: "Bamsopoong" },
                    { question: "What is the name of this song?", image: "/audios/Illit/IYKYK.mp3", choices: ["Tick-Tack", "IYKYK", "Cherish My Love", "I'll Like You"], answer: "IYKYK" },
                    { question: "What is the name of this song?", image: "/audios/Illit/Jellyous.mp3", choices: ["Little Monster", "Jellyous", "Do the Dance", "Oops"], answer: "Jellyous" },
                    { question: "What is the name of this song?", image: "/audios/Illit/NOT ME.mp3", choices: ["Pimple", "NOT CUTE ANYMORE", "NOT ME", "Desperate"], answer: "NOT ME" },
                    { question: "What is the name of this song?", image: "/audios/Illit/RUN.mp3", choices: ["Pride", "Scrum", "Aim High", "RUN"], answer: "RUN" }
                ]
            }
        },
        {   
            ...
            levels: {
                ...
                easy: [
                    ...
                    { question: "What is the name of the title track UNIS debuted with?", choices: ["Dream of Girls", "Dopamine", "Curious", "Super Woman"], answer: "Super Woman" }
                ],
                ...
                hard: [
                    ...
                    { question: "What is the Duo name of Elisia and Yunha", choices: ["Bbangduz", "Eliwon", "Yootoko", "Nanalee"], answer: "Bbangduz" },
                    { question: "What is the Duo name of Nana and Gehlee", choices: ["Kotowon", "Nanalee", "Eliwon", "Yootoko"], answer: "Nanalee" },
                    { question: "What is the Duo name of Seowon and Elisia", choices: ["Nanalee", "Kotowon", "Bbangduz", "Eliwon"], answer: "Eliwon" },
                    { question: "What is the Duo name of Kotoko and Seowon", choices: ["Yootoko", "Bbangduz", "HyeoYoon", "Kotowon"], answer: "Kotowon" },
                    { question: "What is the Duo name of Yoona and Hyeonju", choices: ["Kotowon", "Yootoko", "Nanalee", "HyeoYoon"], answer: "HyeoYoon" },
                    { question: "What is the name of the song Unis released for the fans?", choices: ["Good Feeling", "See you in my dreams", "From a seed called ‘Hey, what’s up?’", "Poppin"], answer: "See you in my dreams" },
                    { question: "What is the name of the first Japanese release of Unis?", choices: ["Shaking my Head", "Swicy", "Mwah", "Moshi-Moshi"], answer: "Moshi-Moshi" },
                    { question: "What is the name of this song?", image: "/audios/UNIS/Datin' Myself.mp3", choices: ["Datin' Myself", "Super Woman", "Butterfly's Dream", "Poppin"], answer: "Datin' Myself" },
                    { question: "What is the name of this song?", image: "/audios/UNIS/DDANG.mp3", choices: ["From a seed called ‘Hey, what’s up?’", "DDANG", "Swicy", "Curious"], answer: "DDANG" },
                    { question: "What is the name of this song?", image: "/audios/UNIS/Dopamine.mp3", choices: ["Yummy Yum", "Curious", "Rush Hour", "Dopamine"], answer: "Dopamine" },
                    { question: "What is the name of this song?", image: "/audios/UNIS/Dream of Girls.mp3", choices: ["WHATCHU NEED", "Dream of Girls", "Camera", "Whateva"], answer: "Dream of Girls" },
                    { question: "What is the name of this song?", image: "/audios/UNIS/Spring Rain.mp3", choices: ["Camera", "Good Feeling", "Spring Rain", "WHATCHU NEED"], answer: "Spring Rain" }
                ]
            }
        },
        {   
            ...
            levels: {
                ...
                easy: [
                    ...
                    { question: "What is the name of the title track AHOF debuted with?", choices: ["The Universe", "Incompleted", "Pinocchio", "Rendezvous"], answer: "Rendezvous" }
                ],
                ...
                medium: [
                    ...
                    { question: "What is the Representative Animals of Steven?", choices: ["Fox", "Duck", "Dog", "Bear"], answer: "Fox" },
                    { question: "What is the Representative Animals of Jeongwoo?", choices: ["Deer", "Dog", "Frog", "Duck"], answer: "Dog" },
                    { question: "What is the Representative Animals of Woongki?", choices: ["Frog", "Deer", "Cat", "Duck"], answer: "Duck" },
                    { question: "What is the Representative Animals of Shuaibo?", choices: ["Frog", "Hamster", "Bunny", "Racoon"], answer: "Frog" },
                    { question: "What is the Representative Animals of Han?", choices: ["Tiger", "Dog", "Frog", "Cat"], answer: "Cat" },
                    { question: "What is the Representative Animals of JL?", choices: ["Bunny", "Racoon", "Duck", "Bear"], answer: "Racoon" },
                    { question: "What is the Representative Animals of Juwon?", choices: ["Tiger", "Cat", "Fox", "Duck"], answer: "Tiger" },
                    { question: "What is the Representative Animals of Chih-en?", choices: ["Racoon", "Dog", "Bunny", "Tiger"], answer: "Bunny" },
                    { question: "What is the Representative Animals of Daisuke?", choices: ["Dog", "Bear", "Fox", "Hamster"], answer: "Bear" },
                ...
                hard: [
                    ...
                    { question: "What is the Duo name of Steven and JL", choices: ["BokiBokiz", "Jewelz", "Stewoo", "Stejay"], answer: "Stejay" },
                    { question: "What is the Duo name of JL and Juwon", choices: ["Hanwoo", "Stejay", "BokiBokiz", "Jewelz"], answer: "Jewelz" },
                    { question: "What is the Duo name of Jeongwoo and Steven", choices: ["BokiBokiz", "Stewoo", "Hanwoo", "Maknaez"], answer: "Stewoo" },
                    { question: "What is the Duo name of Han and Jeongwoo", choices: ["Stejay", "Bbangduz", "Stewoo", "Hanwoo"], answer: "Hanwoo" },
                    { question: "What is the Duo name of Shuaibo and Woongki", choices: ["Maknaez", "Jewelz", "Stejay", "BokiBokiz"], answer: "BokiBokiz" },
                    { question: "What is the Duo name of Daisuke and Chih-en", choices: ["Hanwoo", "Stewoo", "Maknaez", "Jewelz"], answer: "Maknaez" },
                    { question: "What is the name of this song?", image: "/audios/AHOF/Everything is Love.mp3", choices: ["We Ready", "My, My, My", "Only U", "Everything is Love"], answer: "Everything is Love" },
                    { question: "What is the name of this song?", image: "/audios/AHOF/Ignition.mp3", choices: ["Ignition", "Don't Hit the Brakes", "Tag", "Prison"], answer: "Ignition" },
                    { question: "What is the name of this song?", image: "/audios/AHOF/Mamma Mia.mp3", choices: ["The Sleeping Diary", "Roller Coaster", "Mamma Mia", "Incompleted"], answer: "Mamma Mia" },
                    { question: "What is the name of this song?", image: "/audios/AHOF/The Little Star.mp3", choices: ["Never Lose You", "The Little Star", "Cosmic Underdog", "La Fiesta"], answer: "The Little Star" },
                    { question: "What is the name of this song?", image: "/audios/AHOF/The Universe.mp3", choices: ["The Universe", "Sunset in the Sky", "Dreaming", "Anywhere, I'll Be With You"], answer: "The Universe" }
                ]
            }
        }
    ]);
